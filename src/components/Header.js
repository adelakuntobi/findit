    ...
    <header className="py-16 lg:py-24 overflow-hidden relative bg-orange-100">
      ...
      <div className="flex flex-col-reverse lg:flex-row justify-between items-center container mx-auto w-full lg:w-11/12 px-5">
        <div className="w-full lg:w-1/2 z-10">
          <h1 className="font-extrabold text-4xl lg:text-5xl capitalize mt-8 leading-tight">Find Products you Like with all Desired Features</h1>
        ...
        <img className="hidden lg:block lg:w-5/12 " src={theSVG} alt="" />
        <img className="block lg:hidden w-full z-10" src={theSVG1} alt="" />
      </div>
    </header>
  )
}
