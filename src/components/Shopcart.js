...
function Shopcart() {
  return (
    <section className="container mx-auto flex flex-col md:flex-row justify-between items-center w-8/12 my-6">
      <img className="w-6/12 md:w-3/12 mx-6 " src="https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_.jpg" alt="cart" />
      <div className="flex justify-between flex-col text-left mx-8 items-start">
        <div>
          <h1 className="text-xl font-bold">Fjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops</h1>
        ...
        <button className="rounded py-2 px-5 bg-orange text-white mr-4">Delete</button>
      </div>
    </section>
  )
}
